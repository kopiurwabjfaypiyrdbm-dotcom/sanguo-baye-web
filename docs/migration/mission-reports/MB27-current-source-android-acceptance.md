...
- 历史 ADB `input tap 1280 795` 诊断截图：[mb27-after-adb-tap.png](../../godot/builds/mb27-after-adb-tap.png)。该文件时间早于本次 08:35:51 当前 APK，画面仍是旧版上下布局；它只保留作坐标注入历史，不支持当前 APK 的开局页结论，也不是人工触控证据。

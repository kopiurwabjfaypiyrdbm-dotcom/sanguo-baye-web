...
const cities: Record<string, City> = {
  ...
  chenliu: city('chenliu', '陈留', 620, 320, 'city', '兖州', 'cao-cao', ['luoyang', 'xuchang'], 420000, 430, 500, 320),
...
const officers: Record<string, Officer> = {
  'cao-cao': officer('cao-cao', '曹操', 84, 90, 86, 'cavalry', 'cao-cao', 'luoyang', 6200, 100, 45),
  'xiahou-dun': officer('xiahou-dun', '夏侯惇', 92, 64, 78, 'cavalry', 'cao-cao', 'luoyang', 5000, 94, 39),
  'xun-yu': officer('xun-yu', '荀彧', 35, 96, 74, 'infantry', 'cao-cao', 'xuchang', 2600, 98, 42),
  'zhang-liao': officer('zhang-liao', '张辽', 94, 78, 88, 'cavalry', 'cao-cao', 'chenliu', 5400, 92, 36),
  'liu-bei': officer('liu-bei', '刘备', 85, 76, 84, 'cavalry', 'liu-bei', 'chengdu', 5600, 100, 43),
  'guan-yu': officer('guan-yu', '关羽', 106, 81, 94, 'infantry', 'liu-bei', 'hanzhong', 6200, 98, 41, 'qinglong-blade'),
  'zhuge-liang': officer('zhuge-liang', '诸葛亮', 38, 100, 96, 'mystic', 'liu-bei', 'xiangyang', 4200, 100, 32),
  'zhang-fei': officer('zhang-fei', '张飞', 99, 45, 82, 'cavalry', 'liu-bei', 'jiangzhou', 5800, 91, 39),
  'sun-quan': officer('sun-quan', '孙权', 74, 73, 80, 'cavalry', 'sun-quan', 'jianye', 5200, 100, 30),
